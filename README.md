...
```
bash -c "$(wget -qO- https://raw.githubusercontent.com/gisa26/xray_dugong/refs/heads/main/install.sh)"
```
```
bash -c "$(curl -fsSL https://raw.githubusercontent.com/gisa26/xray_dugong/refs/heads/main/install.sh)"
```


**Link Instalasi Opsi 2**
```
bash -c "$(wget -qO- https://raw.githubusercontent.com/gisa26/xray_dugong/refs/heads/main/install2.sh)"
```
```
